...
<table  id="sortMe" style = "background-color: #FFFFFF;" class="table table-hover">
 ...
 ?> 
  ...
  <td  data-label="Modifier" style = "background-color: #FFFFFF;"><a href="ModifierIdentifiantForm.php?Nom=<?php echo $ListeIdentifiant[$i]["Nom"]?>&Prenom=<?php echo $ListeIdentifiant[$i]["Prenom"] ?> &Email=<?php echo $ListeIdentifiant[$i]["Email"] ?>&Mdp=<?php echo $ListeIdentifiant[$i]["Mdp"] ?>" ><button class ="btn btn-outline-warning">Modifier</button></a></td>
    </tr>
    <?php
        $i = $i + 1;
     }
...
while($count<$countIdentifiant){
  ?>
    <a href="GererIdentifiant.php?startingRow=12&rowNumber=<?php echo($count) ?>"><?php echo($i); ?></a>

...
--
-- Serveur: localhost
-- Généré le : Dim 24 Novembre 2019 à 12:58
...
INSERT INTO `attribuer` (`RefVisiteur`, `RefMateriel`, `DateAttribution`, `DateRestitution`) VALUES
('a131', 'X01', '2019-11-01', NULL),
('aaa', 'X01', '2015-01-01', '2016-01-01'),
('g53', 'X02', '2015-01-01', '2015-01-01');
...
INSERT INTO `materiel` (`Reference`, `IdModele`, `Marque`, `Prix`) VALUES
('X01', 1, NULL, NULL),
('X02', 1, NULL, NULL),
('X03', 2, NULL, NULL),
('X04', 1, NULL, NULL),
